# Module main
# Description: This module reads a CSV file containing temperature readings and 
# converts them to either Celsius or Fahrenheit. The converted temperatures are 
# then written to a new CSV file.
